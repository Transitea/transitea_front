...
export const navMain: NavItemProps[] = [
  ...
  { icon: 'bi-box-seam', label: 'Colis', path: paths.colis },
...
export const navManagement: NavItemProps[] = [
  { icon: 'bi-person-gear', label: 'Utilisateurs', path: paths.utilisateurs, adminOnly: true },
  { icon: 'bi-bell', label: 'Notifications', path: paths.notifications },
